...
|2021.05.13|이코테(heap) - 개념(py)|
|2021.05.28|이코테(bin search) - 개념(py), 부품 찾기(py), 떡볶이 떡 만들기(py)|
|2021.06.09|이코테(dp) - 1로 만들기(py), 개미전사(py), 바닥공사(py), 효율적인 화폐 구성(py)|
> Programmers
...
|2021.05.14| programmers(heap) - 디스크 컨트롤러</br>programmers(dfs/bfs) - 네트워크|
